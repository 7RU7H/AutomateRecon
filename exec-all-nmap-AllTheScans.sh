...
wait
sudo nmap $nmap_pn_flag -p- -oA $cwd/nmap/$dash_delimited_ip-All-TCP-slow --min-rate 10 $1
wait
sudo nmap $nmap_pn_flag -sU -oA $cwd/nmap/$dash_delimited_ip-All-UDP --min-rate $2 -e $3 -p- $1
wait
echo ""
echo "Nmap has finish all 6 Scans against $1"
echo ""
